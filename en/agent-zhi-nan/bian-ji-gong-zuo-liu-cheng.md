...
<table><thead><tr><th width="183">Workflow function menu items (from left to right in the picture above)</th><th>illustrate</th></tr></thead><tbody><tr><td>Previous step, next step</td><td>Go back to the previous step, or go back to the next step</td></tr><tr><td>historical record</td><td>Manage workflow editing history</td></tr><tr><td>Export file</td><td>Export this workflow as a file</td></tr><tr><td>Show minimap</td><td>Show or hide the minimap in the lower right corner of the screen</td></tr><tr><td>Reset view</td><td>Center and display the entire workflow</td></tr><tr><td>fold</td><td>Collapse all nodes in the editor</td></tr><tr><td>Edit global variables</td><td>Editing global variables in a workflow</td></tr><tr><td>scrapbook</td><td>Save selected nodes and access them anytime</td></tr><tr><td>store</td><td>Save workflow changes</td></tr><tr><td>Test preview</td><td>Open a chat window to test the workflow (this button will not appear when editing from a workflow template)</td></tr></tbody></table>
