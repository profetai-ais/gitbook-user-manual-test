...
## **Explore Agents and Applications in AI Studio**

After logging in, you will enter the "Workspace" page by default. Users can discover the Agents and application templates they want to use here, and add them to their personal collection to start using them.
...
## **View Agents and Applications in Personal Collection**
...
* **Application Template Card**: When the mouse is moved over the card, the "View" button will be displayed. After clicking, the prompt word content will be displayed.
